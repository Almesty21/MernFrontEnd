...
export const placeOrder = (subtotal) => async (dispatch, getState) => {
			...
			handler: async (response) => {
				try {
					const { data } = await axios.post(
						'https://pizzadelivary.onrender.com/api/payment/verifypayment',
	...
	try {
		const { data } = await axios.post(
			'https://pizzadelivary.onrender.com/api/payment/orders',
			{ subtotal },
		);
...
export const getUserOrders = () => async (dispatch, getState) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/payment/getuserorders',
			{ userId: user._id },
		);
...
export const getAllOrders = () => async (dispatch) => {
	...
	try {
		const response = await axios.get(
			'https://pizzadelivary.onrender.com/api/payment/getallorders',
		);
		console.log(response);
...
export const deliverOrder = (orderid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/payment/deliverorder',
			{ orderid: orderid },
		);
		console.log(response);
