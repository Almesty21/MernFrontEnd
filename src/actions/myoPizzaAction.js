...
export const getAllToppings = () => async (dispatch) => {
	...
	const response = await axios.get(
		'https://pizzadelivary.onrender.com/api/myopizza/getalltoppings',
	);
	// console.log(response);
...
export const getAllCheese = () => async (dispatch) => {
	...
	const response = await axios.get(
		'https://pizzadelivary.onrender.com/api/myopizza/getallcheese',
	);
	// console.log(response);
...
export const addBase = (base) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/myopizza/addbase',
			{ base: base },
		);
		console.log(response);
...
export const getBaseById = (baseid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/myopizza/getbasebyid',
			{ baseid: baseid },
		);
		console.log(response);
...
export const updateBase = (updatedBase) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/myopizza/updatebase',
...
export const deleteBase = (baseid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/myopizza/deletebase',
			{ baseid: baseid },
		);
		console.log(response);
...
export const addTopping = (topping) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/myopizza/addtopping',
			{ topping: topping },
		);
		console.log(response);
...
export const getToppingById = (toppingid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/myopizza/gettoppingbyid',
			{ toppingid: toppingid },
		);
		console.log(response);
...
export const updateTopping = (updatedTopping) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/myopizza/updatetopping',
...
export const deleteTopping = (toppingid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizzadelivary.onrender.com/api/myopizza/deletetopping',
			{ toppingid: toppingid },
		);
		console.log(response);
